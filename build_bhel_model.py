...
frow(wc,21,'Other non-current assets (incl deferred tax, NC contract assets)',seed=20934.62,fcst=lambda c:"=%s"%XR(ASM,'other_nca',c),key='onca',indent=1)
frow(wc,22,'Other non-current liabilities (incl NC contract liab, LT provisions)',seed=17568.65,fcst=lambda c:"=%s"%XR(ASM,'other_ncl',c),key='oncl',indent=1)
