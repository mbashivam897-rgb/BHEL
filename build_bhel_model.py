...
aR('Contract assets - current (% rev)','45% -> 39%','Unbilled revenue on long-cycle EPC (percentage-of-completion). Audited FY26 current contract assets = 45% of revenue. Tapered down per management guidance (Q4FY24 concall, 21-May-24): legacy NTPC projects clearing, faster milestone billing and improved payment terms -> working capital "getting better".')
